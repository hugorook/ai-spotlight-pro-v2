            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button 
                    onClick={copyGeoResultsToClipboard} 
                    className="px-3 py-1.5 bg-muted hover:bg-muted/80 text-muted-foreground rounded text-sm font-medium transition-colors"
                  >
                    📋 Copy Results
                  </button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-muted/30 rounded-lg p-4 text-center">
                  ...
                  <div className="text-sm text-muted-foreground">
                    {lastRunType === 'health' ? 'Prompts Tested' : 'Custom Prompt'}
                  </div>
                </div>
                <div className="bg-muted/30 rounded-lg p-4 text-center">
                  <div className="text-2xl font-bold text-green-500 mb-1">
                    {Math.round((lastResults.filter(r => r.mentioned).length / lastResults.length) * 100)}%
                  </div>
                  <div className="text-sm text-muted-foreground">
                    Mention Rate
                  </div>
