...
import { Globe, Settings, Shield, Code, Copy, CheckCircle2, AlertCircle, Zap, Activity } from 'lucide-react'
...
export default function SiteConnection() {
            ...
            <CardContent>
              <div className="grid md:grid-cols-3 gap-4">
                <div className="text-center p-4 border rounded-lg">
                  ...
                  <div className="font-medium text-sm">Site Script</div>
                  <div className="text-xs text-gray-600">
                    {project?.site_script_status === 'connected' ? 'Connected' : 'Not Connected'}
                  </div>
                </div>
                <div className="text-center p-4 border rounded-lg">
                  <div className={`w-4 h-4 rounded-full mx-auto mb-2 ${
                    project?.cms_provider !== 'manual' ? 'bg-green-500' : 'bg-yellow-500'
                  }`}></div>
                  <div className="font-medium text-sm">CMS Integration</div>
                  <div className="text-xs text-gray-600 capitalize">{project?.cms_provider || 'Manual'}</div>
                </div>
                <div className="text-center p-4 border rounded-lg">
                  <div className={`w-4 h-4 rounded-full mx-auto mb-2 ${
                  ...
                  <div className="text-xs text-gray-600">
                    {project?.autopilot_enabled ? 'Active' : 'Disabled'}
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg">
                ...
                <Switch
                  checked={project?.autopilot_enabled || false}
