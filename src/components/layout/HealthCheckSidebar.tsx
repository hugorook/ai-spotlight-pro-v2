...
const HealthCheckSidebar: React.FC<HealthCheckSidebarProps> = ({
  ...
  return (
    <div className="fixed left-0 top-16 h-[calc(100vh-4rem)] w-64 z-[100] glass-strong backdrop-blur-xl border-r border-white/20">
        ...
        <button
          ...
          className={cn(
            ...
            isRunning 
              ...
              : "bg-[#111E63] text-white hover:bg-[#111E63]/90"
          )}
        >
